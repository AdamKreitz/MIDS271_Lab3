...
```{r average year plot, echo=F, warning=F}
...
```{r box plot of total fatality rate by speed limit, echo=F, warning=F}
data %>%
...
```{r total fatality rate per state, echo=F, warning=F}
data %>%
...
```{r boxplot of total fatality rate by bac, echo=F, warning=F}
data %>%
